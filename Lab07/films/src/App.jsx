...
function App() {
    ...
    // This state controls the visibility of the form
    const [formVisible,setFormVisible]=useState('button'); // button, add, edit
            ...
            <Container fluid className="flex-grow-1 d-flex flex-column">
                <Row className="flex-grow-1">
                    ...
                    <Col md={9} className="pt-3">
                        ...
                        <FilmList films={visibleFilms} setFormVisible={setFormVisible} setEditableFilm={setEditableFilm}/>
                        {formVisible==='add' && <FilmForm closeForm={()=>setFormVisible('button')} addFilm={addFilm}></FilmForm>}
                        {formVisible==='edit' && <FilmForm closeForm={()=>setFormVisible('button')} updateFilm={updateFilm} film={editableFilm} key={editableFilm.id}></FilmForm>}
                    </Col>
                </Row>
