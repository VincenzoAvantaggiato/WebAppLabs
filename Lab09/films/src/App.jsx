...
function App() {
    ...
    useEffect(() => {
        const getFilms = async () => {
          const films = await API.getFilms(activeFilter);
          setFilms(films);
        }
        getFilms();
      }, [activeFilter]);
    ...
    const updateFilm = (film) => {
        setFilms(old_films=>old_films.map( f =>{
            if (f.id==film.id) {
                console.log('update');
                return new Film(f.id,film.title,film.favorite,film.watchDate,film.rating);
            }
            else return f;
        }
        ))
    ...
    return (
        <Routes>
            <Route path="/" element={
                ...
                <Header isSidebarExpanded={isSidebarExpanded} setIsSidebarExpanded={setIsSidebarExpanded} setActiveFilter={setActiveFilter}/>
                ...
                <Container fluid className="flex-grow-1 d-flex flex-column">
                    ...
                    <Row className="flex-grow-1">
                        ...
                        <Col md={9} className="pt-3">
                            ...
                            <FilmList films={films} setEditableFilm={setEditableFilm} deleteFilm={deleteFilm} updateFilm={updateFilm}/>
                        </Col>
                    ...
                    <Route path={"filter/:filter"} element={<FilterRoutes isSidebarExpanded={isSidebarExpanded} filters={filters} films={films} setActiveFilter={setActiveFilter} setEditableFilm={setEditableFilm} deleteFilm={deleteFilm} updateFilm={updateFilm}></FilterRoutes>}>
                    </Route>
