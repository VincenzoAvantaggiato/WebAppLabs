...
function FilmList(props) {
    ...
    return (<ListGroup id="films-list" variant="flush">
        {films.map((film) => <FilmInList filmData={film} key={film.id} setFormVisible={props.setFormVisible} setEditableFilm={props.setEditableFilm} deleteFilm={props.deleteFilm} updateFilm={props.updateFilm}/>)}
    </ListGroup>);
}
    ...
    return (<ListGroupItem>
        <Row className="gy-2">
            ...
            <span className="custom-control custom-checkbox">
              <span className="custom-control custom-checkbox">
                          <input type="checkbox" className="custom-control-input" checked={filmData.favorite} onClick={()=>props.updateFilm(new Film(filmData.id,filmData.title,!filmData.favorite,filmData.watchDate,filmData.rating,filmData.userID))}/>
