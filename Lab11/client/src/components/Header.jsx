...
function Header({isSidebarExpanded, setIsSidebarExpanded, ...props}) {
        ...
        <Container fluid className="gap-3 align-items-center">
            <Row>
                ...
                <Col xs={3} md={8} className="d-flex align-items-center justify-content-end">
                    ...
                    {!props.loggedIn && <Link to="/login" className="btn btn-primary">Login</Link>}
                    {props.loggedIn && <Button className="btn-primary" onClick={()=>props.handleLogout()}>Logout</Button>}
                </Col>
            </Row>
        </Container>
    </header>;
