...
export function FilmListLayout(props) {
  ...
  return (
    <>
      ...
      <FilmList films={props.films} updateFilm={props.updateFilm} deleteFilm={props.deleteFilm} update={props.update}/>
      <Row><Col>
...
export function EditLayout(props) {
  ...
  return(!editableFilm ?
    ...
    : <Row><Col><FilmForm film={editableFilm} filmId={filmId}/></Col></Row>
  );
}
